...
Part of Stack's problem, aside the CEO deciding to push for anything fancy at any cost, is that they seem to fail to focus on multiple concerns at once. On a community-driven site, not addressing the needs of the community is a surefire way to erode trust and lose more traffic. They are a for-profit company, and profits matter, but that doesn't mean the concerns of the community can't be addressed too. There's usually a middle ground between the concerns of the community, and what's beneficial for profits. Usually, doing stuff beneficial to the community _is_ beneficial to profits, as it means better user retention. 

However, instead of taking this approach, SE continues to alienate its community, and focus on profit at the expense of the community that the site needs to function. No community means no content, and no content means no money, a fact SE seems to forget. As long as they fail to balance their financial commitments with the commitments of running a community-driven service, these types of problems will continue to happen regularly.
