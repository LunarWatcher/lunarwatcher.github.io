...
![Screenshot showing the network-manager applet on Linux Mint, Cinnamon edition. The applet contains three sections; a censored block of wireless connections, an OpenVPN connection with a ProtonVPN entry, and a wireguard section with an active connection](../../static/img/2024-12-25-network-manager.png)
