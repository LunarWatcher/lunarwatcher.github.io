...
> [!tip]
> `C-c C-c` shows a list of the next possible characters and what they do, though it doesn't include the full list. Would recommend looking at [`describe-mode` as well](listing-variables.md)
